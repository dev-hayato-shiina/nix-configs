...
}:
{
  ...
  config.settings.config_directory = "/home/hayato-shiina/.config/nvim";
  ...
  config.specs.general = {
    ...
    data = with pkgs.vimPlugins; [
      ...
      config.nvim-lib.neovimPlugins.babel-nvim
      config.nvim-lib.neovimPlugins.fcitx5-nvim
      config.nvim-lib.neovimPlugins.lazydocker-nvim
