{
  ...
  inputs.plugins-babel-nvim = {
    url = "github:acidsugarx/babel.nvim";
    flake = false;
  };
  inputs.plugins-fcitx5-nvim = {
    url = "github:pysan3/fcitx5.nvim";
    flake = false;
  };
  inputs.plugins-lazydocker-nvim = {
    url = "github:mgierada/lazydocker.nvim";
    flake = false;
  };
  outputs =
    {
